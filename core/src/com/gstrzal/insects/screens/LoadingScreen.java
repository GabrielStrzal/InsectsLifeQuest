...
public class LoadingScreen extends ScreenAdapter{
    ...
    public void show() {
        ...
        assetManager.load(Constants.MENU_SELECT_LEVEL_RIGHT_PRESSED_BUTTON, Texture.class);
        assetManager.load(Constants.MENU_SELECT_LEVEL_LEFT_BUTTON, Texture.class);
        assetManager.load(Constants.MENU_SELECT_LEVEL_LEFT_PRESSED_BUTTON, Texture.class);
        ...
        assetManager.load(Constants.LEVEL_STATS_IN_GAME, Texture.class);
        ...
        assetManager.load(Constants.MINIGAMES_GLIDING_BUGS, Texture.class);
        ...
        assetManager.load(Constants.LEVEL_26, TiledMap.class);
        assetManager.load(Constants.LEVEL_27, TiledMap.class);
        assetManager.load(Constants.LEVEL_28, TiledMap.class);
        assetManager.load(Constants.LEVEL_29, TiledMap.class);
        assetManager.load(Constants.LEVEL_30, TiledMap.class);
        assetManager.load(Constants.LEVEL_31, TiledMap.class);
        assetManager.load(Constants.LEVEL_32, TiledMap.class);
        assetManager.load(Constants.LEVEL_33, TiledMap.class);
        assetManager.load(Constants.LEVEL_34, TiledMap.class);
        assetManager.load(Constants.LEVEL_35, TiledMap.class);
        assetManager.load(Constants.LEVEL_36, TiledMap.class);
        assetManager.load(Constants.LEVEL_37, TiledMap.class);
        assetManager.load(Constants.LEVEL_38, TiledMap.class);
        assetManager.load(Constants.LEVEL_39, TiledMap.class);
        assetManager.load(Constants.LEVEL_40, TiledMap.class);
        assetManager.load(Constants.LEVEL_41, TiledMap.class);
        assetManager.load(Constants.LEVEL_42, TiledMap.class);
        assetManager.load(Constants.LEVEL_43, TiledMap.class);
        assetManager.load(Constants.LEVEL_44, TiledMap.class);
        assetManager.load(Constants.LEVEL_45, TiledMap.class);
        assetManager.load(Constants.LEVEL_46, TiledMap.class);
        assetManager.load(Constants.LEVEL_47, TiledMap.class);
        assetManager.load(Constants.LEVEL_48, TiledMap.class);
        assetManager.load(Constants.LEVEL_49, TiledMap.class);
        assetManager.load(Constants.LEVEL_50, TiledMap.class);
        assetManager.load(Constants.LEVEL_51, TiledMap.class);
        assetManager.load(Constants.LEVEL_52, TiledMap.class);
        assetManager.load(Constants.LEVEL_53, TiledMap.class);
